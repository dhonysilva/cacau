defmodule CacauWeb.Router do
  ...
  scope "/", CacauWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{CacauWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", CacauWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{CacauWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", CacauWeb do
    ...
    live_session :current_user,
      on_mount: [{CacauWeb.UserAuth, :mount_current_user}] do
